...
function mcImgSlider(j) {
    ...
    ab.prototype = {c: function () {
        ...
        while (j--) {
            f = i[j];
            if (f[D] == "BR")e.removeChild(f); else {
                f[c][R] = "none";
                o.push(f);
                if (f[D] == "A") {
        ...
        e[c][J] = 'url("' + b.e[p]("src") + '") no-repeat center';
        this.i();
        L = this.k();
        var g = this.v(), h = b.e[y];
        if (this.z(h) && h[p]("autoPlayVideo") == "true")this.d(h); else if (a.i && b.d > 1)q = setTimeout(function () {
            g.y(g.n(1), 0, 1)
        }, a.b + a.c);
        if (a.h) {
        ...
        var e = 1;
        if (G.innerHTML[d] > 1)if (!a.k)k[c][z] = n[c][z] = "hidden"; else {
            e = 0;
        ...
        e[c][J] = 'url("' + b.e[p]("src") + '") no-repeat center';
        var f = this, d = b.e[y];
        if (this.z(d) && d[p]("autoPlayVideo") == "true")this.d(d); else if (!b.b && a.i)q = setTimeout(function () {
            f.y(f.n(b.a + 1), 0, 1)
        }, a.b);
        ...
        if (c < 9)this.q(f, c); else if (c < 13)this.r(f, c); else if (c == 13)this.s(f); else if (c < 16)this.t(f, c); else this.u(f, c)
    }, q: function (b, e) {
        ...
        for (var k = [], j = i > 8 ? s : Math.round(s / a.f), l = i > 8 ? 1 : a.f, h = 0; h < l; h++) {
            ...
            f[c][v] = "0px";
            f[c][J] = 'url("' + b.e[p]("src") + '") no-repeat center -' + h * j + "px 0%";
            if (i == 10)f[c][J] = 'url("' + b.e[p]("src") + '") no-repeat center'; else if (i == 12)f[c][J] = 'url("' + b.e[p]("src") + '") no-repeat center';
            f[c].zIndex = 1;
        ...
        for (var k = [], j = Math.round(s / a.g), i = Math.round(w / a.m), h = 0; h < a.m; h++)for (var f = 0; f < a.g; f++) {
            ...
            d[c][g] = d.w + "px";
            d[c][v] = d.h + "px";
            d[c][J] = 'url("' + b.e[p]("src") + '") no-repeat center -' + f * j + "px -" + h * i + "px";
            d[c].zIndex = 1;
